...
function emailSend() {
    ...
    Email.send({
        ...
        Username: "ketozone6@gmail.com",
        Password: "59A263BBE63881E4D11F861A8D9F46E5BC80",
        To: 'ketozone6@gmail.com',
        From: "ketozone6@gmail.com",
        Subject: "This is Keto zone order",
        Body: messageBody
    }).then(
        message => {
            if (message == 'OK') {
