...
function emailSend() {
    ...
    Email.send({
        ...
        Username: "thenutritionist1130@gmail.com",
        Password: "BDDCF78285DDC40545DECB85A3CD78498476",
        To: 'thenutritionist1130@gmail.com',
        From: "thenutritionist1130@gmail.com",
        Subject: "This is The Nutritionist order",
        Body: messageBody
    }).then(
        message => {
            if (message == 'OK') {
