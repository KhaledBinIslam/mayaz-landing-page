...
function emailSend() {
    ...
    Email.send({
        ...
        Username: "tdreamwizards@gmail.com",
        Password: "337DF0C4E8E5FAF110AA890A9D2E16406E3E",
        To: 'tdreamwizards@gmail.com',
        From: "tdreamwizards@gmail.com",
        Subject: "This is Coffee With Soul order",
        Body: messageBody
    }).then(
        message => {
            if (message == 'OK') {
