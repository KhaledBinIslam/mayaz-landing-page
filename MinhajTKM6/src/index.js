...
function emailSend() {
    ...
    Email.send({
        ...
        Username: "nutritionsanctuary524@gmail.com",
        Password: "42408DDAC08B1054F6582E311E9FC5D2938D",
        To: 'nutritionsanctuary524@gmail.com',
        From: "nutritionsanctuary524@gmail.com",
        Subject: "This is NUTRITION SANCTUARY order",
        Body: messageBody
    }).then(
        message => {
            if (message == 'OK') {
