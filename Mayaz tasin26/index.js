...
function emailSend() {
  ...
  Email.send({
    ...
    Username: "wellnessbluetea@gmail.com",
    Password: "7415B35F6450320909EEB970BDFF1E3E92FF",
    To: 'wellnessbluetea@gmail.com',
    From: "wellnessbluetea@gmail.com",
    Subject: "This is WELLNESS BLUE TEA order",
    Body: messageBody
  }).then(
    message => {
      if (message == 'OK') {
