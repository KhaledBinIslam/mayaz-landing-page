...
function emailSend() {
    ...
    Email.send({
        ...
        Username: "weightlossketobluetea@gamil.com",
        Password: "754E67BB2EE485821F4F79A05081A467F6CA",
        To: 'weightlossketobluetea@gmail.com',
        From: "weightlossketobluetea@gmail.com",
        Subject: "This is  Keto Blue Tea order",
        Body: messageBody
    }).then(
        message => {
            if (message == 'OK') {
