...
function emailSend() {
    ...
    Email.send({
        ...
        Username: "easydiet881@gmail.com",
        Password: "66CBD50B4955E8EC4A449D6898C477BE96C1",
        To: 'easydiet881@gmail.com',
        From: "easydiet881@gmail.com",
        Subject: "This is Eco Keto Genic Diet order",
        Body: messageBody
    }).then(
        message => {
            if (message == 'OK') {
