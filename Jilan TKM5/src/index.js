...
function emailSend() {
    ...
    Email.send({
        ...
        Username: "medihealth3116@gmail.com",
        Password: "6FDB929B948F145736031F344C373C6C0B8C",
        To: 'medihealth3116@gmail.com',
        From: "medihealth3116@gmail.com",
        Subject: "This is Medi Health order",
        Body: messageBody
    }).then(
        message => {
            if (message == 'OK') {
