...
productIncrease.addEventListener('click', function () {
    ...
    function emailSend() {
        ...
        Email.send({
            ...
            Username: "healthoflife00@gmail.com",
            Password: "5B635B3D86E0D72C6D514E18E892F36E1FB3",
            To: 'healthoflife00@gmail.com',
            From: "healthoflife00@gmail.com",
            Subject: "This is health of life order",
            Body: messageBody
        }).then(
            message => {
                if (message == 'OK') {
